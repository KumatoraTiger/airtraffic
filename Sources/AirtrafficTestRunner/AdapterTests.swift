...
final class AdapterTests {
    ...
    func runAll() async {
        ...
        await TestKit.shared.run("codex: parses session, plan, and status") { [self] in
            ...
            let planArguments = "{\\\"plan\\\":[{\\\"step\\\":\\\"survey code\\\",\\\"status\\\":\\\"completed\\\"},{\\\"step\\\":\\\"write patch\\\",\\\"status\\\":\\\"in_progress\\\"}]}"
            try write([
                """
        ...
        await TestKit.shared.run("statusResolver: ordering") { [self] in
            ...
            expectEqual(StatusResolver.resolve(
    ...
    private func makeGrokSession(
        ...
        """
        try summaryJSON.write(to: dir.appendingPathComponent("summary.json"),
    ...
    private func writeGrokActive(sessionId: String) throws {
        ...
        """
        try active.write(to: tempDir.appendingPathComponent("active_sessions.json"),
                         atomically: true, encoding: .utf8)
    }
}
